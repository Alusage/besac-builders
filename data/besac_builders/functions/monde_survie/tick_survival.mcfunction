...
execute as @a[scores={placed_hopper=1..},limit=1] anchored eyes at @s run function besac_builders:monde_survie/raycast_hopper
execute as @a[scores={placed_copper_chest=1..},limit=1] anchored eyes at @s run function besac_builders:monde_survie/raycast_copper_chest
