...
execute if entity @e[type=area_effect_cloud,tag=coffre_personnel,limit=1,sort=arbitrary,distance=..1] run tag @s add place_un_coffre
...
#Récupérer les coordonnées du coffre
